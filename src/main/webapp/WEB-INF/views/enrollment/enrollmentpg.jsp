	...
	<div class="container">
		<div class="input-form-backgroud row">
			<div class="input-form col-md-12 mx-auto">
				...
				<form class="validation-form" novalidate action="/enrollment/enrollmentpg"  method="post">
			
						<input type="hidden" class="form-control" name="m_id" id="name" value="${sessionScope.loginId}" required>
          				<input type="hidden" class="form-control" name="r_number" id="name" value="${sessionScope.loginNumber}" required>
          		
            		
            		<div class="mb-3">
						<label for="name">담당교수</label>
						<input type="text" class="form-control" name="e_pro" id="name" value="${sessionScope.loginName}" required>
					</div>
                    ...
                    <div class="row">
						<div class="col-md-6 mb-3">
							<label for="name">강의실</label> <input type="text"
								class="form-control" name="e_space" id="name" placeholder="강의실을 입력해주세요." value="" required>
						</div>
						<div class="col-md-6 mb-3">
							<label for="nickname">수강인원</label> <input type="text"
								class="form-control" name="e_person" id="nickname" placeholder="수강인원을 입력해주세요." value=""
								required>
						</div>
					</div>
