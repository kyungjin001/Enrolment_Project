				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">구매페이지
								</h6>
						</div>
						<div class="card-body">
							<div class="table-responsive">
							
							    <form action="/goods/mycart" method="get" name="mycart">
							    <input class="" type="hidden" value="${goods.g_number}" name="g_number">
							    <input class="" type="hidden" value="${sessionScope.loginNumber}" name="m_number">
							    </form>
							...
							<tr>
								...
								<td>${goods.g_name}</td>
								<td>${goods.g_price}</td>
								<td><img alt="" src="/resources/upload/${goods.g_imagename}"></td>			
								<td>${goods.g_stock}</td>
								<td><button id="check_module" type="button" class="btn btn-warning">카카오페이 구매</button></td>
							</tr>
									<%-- <a href="/goods/mycart?g_number=${goods.g_number}&m_number=${sessionScope.loginNumber}"> --%>
