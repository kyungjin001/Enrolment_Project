		...
		<div class="input-form-backgroud row">
			<div class="input-form col-md-12 mx-auto">
				...
				<form class="validation-form" novalidate action="/board/update"  method="post">
						...
						<input type="hidden" class="form-control" name="t_number" id="name" value="${board.t_number}" readonly required>
            		...
            		<div class="mb-3">
						...
						<input type="text" class="form-control" name="t_title" id="name" placeholder="주제를 입력해주세요." value="${board.t_title}" readonly required>
					</div>
            
            
						<div class="mb-3">
							<label for="name">스터디 지역</label> 
							<input type="text" class="form-control" name="t_area" id="name" placeholder="지역을 입력해주세요." value="${board.t_area}" readonly required>
						</div>
		
		         	<div class="row">
						<div class="col-md-6 mb-3">
							<label for="name">스터디 내용</label>
							<textarea name="t_contents" rows="5" class="form-control">${board.t_contents}</textarea><br>
						</div>
					</div>
